...
extern const float segmentTheta = 60.0/180.0*M_PI; // decrese this value may improve accuracy   點分割時的角度跨度上限（π/3）
extern const int segmentValidPointNum = 5;		   // 檢查上下左右連續5個點做為分割的特徵依據 
